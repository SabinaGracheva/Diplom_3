...
class TestBaseFunctional:
    ...
    def test_switch_to_constructor(self, driver, login):
        ...
        assert main_page.check_build_a_burger_text(), 'Не выполнен переход в "Конструктор"'
    ...
    def test_switch_to_order_feed(self, driver, login):
        ...
        assert order_feed.check_order_feed_text(), 'Не выполнен переход в "Лента заказов"'
    ...
    def test_ingredient_details(self, driver, login):
        ...
        assert main_page.check_modal_window_details_ingredient(), 'Не появляется всплывающее окно "Детали ингредиента"'
    ...
    def test_counter_ingredients(self, driver, login):
        ...
        assert int(counter_1) < int(counter_2), 'Не увеличивается счётчик ингредиента, добавденного в заказ'
    ...
    def test_successful_create_order(self, driver, login):
        ...
        assert main_page.check_order_is_processed(), 'Не оформлен заказ у авторизованного пользователя'
